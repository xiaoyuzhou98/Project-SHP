      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cart.isChecked === 1" @click="checkOne(cart)" />
          </li>
...
export default {
  ...
  methods: {
    ...
    //     this.cartInfoList.forEach((cart) => {
    //       if (cart.isChecked === 1) cart.isChecked = 0;
    //     });
    //   } else {
    //     this.cartInfoList.forEach((cart) => {
    //       if (cart.isChecked === 0) cart.isChecked = 1;
    //     });
    //   }
    // },
